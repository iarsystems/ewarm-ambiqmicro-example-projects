...
//
//*****************************************************************************
#pragma weak am_usagefault_isr=am_default_isr
...
extern __weak void am_mpufault_isr(void);
extern __weak void am_busfault_isr(void);
...
__root const uVectorEntry __vector_table[] @ ".intvec" =
{
    ...
    am_mpufault_isr,                        // The MPU fault handler
    am_busfault_isr,                        // The bus fault handler
    am_usagefault_isr,                      // The usage fault handler
    0,                                      // Reserved
    0,                                      // Reserved
    0,                                      // Reserved
    0,                                      // Reserved
